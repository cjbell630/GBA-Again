...
#include "../images/fnaf_office.h"
#include "../images/fnaf_button_ab.h"
#include "../images/fnaf_button_ab_apower.h"
...
int main() {
    ...
    memcpy(&tile_mem[4][0], fnaf_button_abTiles, fnaf_button_abTilesLen);
    memcpy(&pal_obj_mem[0], fnaf_button_abPal, fnaf_button_abPalLen);
    memcpy(&pal_obj_mem[16], fnaf_button_ab_apowerPal, fnaf_button_ab_apowerPalLen);
    oam_init(obj_buffer, 128);
    //REG_DISPCNT = DCNT_OBJ | DCNT_OBJ_1D; //sets display info

    // Load palette
    memcpy(pal_bg_mem, fnaf_officePal, fnaf_officePalLen);
    // Load tiles into CBB 0
    memcpy(&tile_mem[0][0], fnaf_officeTiles, fnaf_officeTilesLen);
    // Load map into SBB 30
    memcpy(&se_mem[30][0], fnaf_officeMap, fnaf_officeMapLen);
